...
from lightrag.schema import SchemaLoader, SchemaClassifier
...
class LightRAG:
    ...
    # Formula Interpretation Options
    # ---

    enable_formula_interpretation: bool = field(default=get_enhanced_config().enable_formula_interpretation)
    """If True, enables detailed formula interpretation using LLMs."""

    formula_interpretation_level: str = field(default=get_enhanced_config().formula_interpretation_level)
    """Level of detail for formula interpretations. Options: "basic", "detailed"."""

    verify_formula_interpretations: bool = field(default=get_enhanced_config().verify_formula_interpretations)
    """If True, verifies the mathematical accuracy of formula interpretations."""

    extract_formula_explanations: bool = field(default=get_enhanced_config().extract_formula_explanations)
    """If True, extracts formula explanations from surrounding text in documents."""

    identify_formula_relationships: bool = field(default=get_enhanced_config().identify_formula_relationships)
    """If True, identifies relationships between formulas in the same context."""
